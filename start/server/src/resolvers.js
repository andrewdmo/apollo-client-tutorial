...
module.exports = {
    ...
    Mutation: {
        ...
        // returns a login token that clients can use for auth
        ...
        bookTrips: async (_, {launchIds}, {dataSources}) => {
            ...
            return {    // TripUpdateResponse type
    ...
    ,
    User: {
        trips: async (_, __, {dataSources}) => {    // get ids of launches by user
...
// DEFAULT resolver auto defines fields that aren't specified
